...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/software')) {
            ...
            // software_buscar_software
            if ($pathinfo === '/software/buscarsoftware') {
                return array (  '_controller' => 'uniSistemas\\Bundle\\Controller\\softwareController::buscarSoftwareAction',  '_route' => 'software_buscar_software',);
            }

            // software_responder_software
            if ($pathinfo === '/software/respondersoftware') {
                if (!in_array($this->context->getMethod(), array('POST', 'PUT'))) {
                    $allow = array_merge($allow, array('POST', 'PUT'));
                    goto not_software_responder_software;
                }

                return array (  '_controller' => 'uniSistemas\\Bundle\\Controller\\softwareController::responderSoftwareAction',  '_route' => 'software_responder_software',);
            }
            not_software_responder_software:
        ...
        if (0 === strpos($pathinfo, '/hardware')) {
            ...
            if ($pathinfo === '/hardware/buscarhardware') {
        ...
        if (0 === strpos($pathinfo, '/maquinasv')) {
            // maquinasv
            if (rtrim($pathinfo, '/') === '/maquinasv') {
                if (substr($pathinfo, -1) !== '/') {
                    return $this->redirect($pathinfo.'/', 'maquinasv');
                }

                return array (  '_controller' => 'uniSistemas\\Bundle\\Controller\\maquinasvController::indexAction',  '_route' => 'maquinasv',);
            }

            // maquinasv_show
            if (preg_match('#^/maquinasv/(?P<id>[^/]++)/show$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'maquinasv_show')), array (  '_controller' => 'uniSistemas\\Bundle\\Controller\\maquinasvController::showAction',));
            }

            // maquinasv_new
            if ($pathinfo === '/maquinasv/new') {
                return array (  '_controller' => 'uniSistemas\\Bundle\\Controller\\maquinasvController::newAction',  '_route' => 'maquinasv_new',);
            }

            // maquinasv_create
            if ($pathinfo === '/maquinasv/create') {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_maquinasv_create;
                }

                return array (  '_controller' => 'uniSistemas\\Bundle\\Controller\\maquinasvController::createAction',  '_route' => 'maquinasv_create',);
            }
            not_maquinasv_create:

            // maquinasv_edit
            if (preg_match('#^/maquinasv/(?P<id>[^/]++)/edit$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'maquinasv_edit')), array (  '_controller' => 'uniSistemas\\Bundle\\Controller\\maquinasvController::editAction',));
            }

            // maquinasv_update
            if (preg_match('#^/maquinasv/(?P<id>[^/]++)/update$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('POST', 'PUT'))) {
                    $allow = array_merge($allow, array('POST', 'PUT'));
                    goto not_maquinasv_update;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'maquinasv_update')), array (  '_controller' => 'uniSistemas\\Bundle\\Controller\\maquinasvController::updateAction',));
            }
            not_maquinasv_update:

            // maquinasv_delete
            if (preg_match('#^/maquinasv/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('POST', 'DELETE'))) {
                    $allow = array_merge($allow, array('POST', 'DELETE'));
                    goto not_maquinasv_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'maquinasv_delete')), array (  '_controller' => 'uniSistemas\\Bundle\\Controller\\maquinasvController::deleteAction',));
            }
            not_maquinasv_delete:

        }

        // uni_sistemas_homepage
        if ($pathinfo === '/sistemas') {
            return array (  '_controller' => 'uniSistemas\\Bundle\\Controller\\DefaultController::indexAction',  '_route' => 'uni_sistemas_homepage',);
        }

        if (0 === strpos($pathinfo, '/link')) {
            // linkHardware
            if ($pathinfo === '/linkHardware') {
                return array (  '_controller' => 'uniSistemas\\Bundle\\Controller\\hardwareController::buscarHardwareAction',  '_route' => 'linkHardware',);
            }

            // linkSoftware
            if ($pathinfo === '/linkSoftware') {
                return array (  '_controller' => 'uniSistemas\\Bundle\\Controller\\softwareController::buscarSoftwareAction',  '_route' => 'linkSoftware',);
            }
